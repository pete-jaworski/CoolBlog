<?php
namespace PiotrJaworski\CoolBlog\Ui\Component\Listing\Column;
...
{
    /** Url path */
    const BLOG_URL_PATH_EDIT = 'coolblog/post/edit';
    const BLOG_URL_PATH_DELETE = 'coolblog/post/delete';
